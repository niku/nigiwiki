defmodule NigiwikiWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Nigiwiki.MyChannel do
        use NigiwikiWeb, :channel
        alias Nigiwiki.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :nigiwiki,
                        pubsub_server: Nigiwiki.PubSub
end
